...
const Card: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://192.168.10.210:8081/TAM/checkin/checkInPage/${checkinIdd}`);
  ...
  const updateCheckInStatus = async (): Promise<void> => {
    try {
      await axios.put(`http://192.168.10.210:8081/TAM/checkin/${userId}/checkInStatus/${checkinIdd}/Successfully`);

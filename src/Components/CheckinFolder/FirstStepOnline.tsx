  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        `http://192.168.10.210:8080/TAM/checkin/numberOfGuestsCheck/${apartmentId}/${number}`
      );
  ...
  return (
    <>
      <FirstStepStyledWrapper>
        <Title>First Step Online Check-in</Title>
        <InputBox>
...
export default FirstOnlineCheckinForm;